...
<head>
    ...
    <title>EC2Box - Set Admin Password</title>
</head>
<body>
    ...
    <div class="container">
        ...
        <s:form action="passwordSubmit" autocomplete="off">
            ...
            <tr> <td>&nbsp;</td>
                <td align="right">  <div id="change_btn" class="btn btn-primary submit_btn" >Change Password</div></td>
            </tr>
        </s:form>
        ...
        <s:form action="themeSubmit">
            ...
            <tr> <td>&nbsp;</td>
                <td align="right">  <div id="theme_btn" class="btn btn-primary submit_btn" >Update Theme</div></td>
            </tr>
        </s:form>
